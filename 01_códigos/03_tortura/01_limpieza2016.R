...
# Objetivo:              Procesamiento inicial de microdatos de 2016
#
...
df_files <- drive_ls(as_id("1qw7cAiBTYj8NEa4DJFoezzpNxrOqVb0z")) 
...
df_binaria <- df_unida                                  %>%
    mutate(
        ...
        ppo = case_when(
            ...
            !(P5_8_10  == 1 | P5_8_11  == 1 | P5_8_15  == 1 | P5_8_22  == 1) ~ 0,
            # Cometió algún delito que amerite PPO (procesados y sentenciados)
             (P5_29_10 == 1 | P5_29_11 == 1 | P5_29_15 == 1 | P5_29_22 == 1) ~ 1,
             (P5_8_10  == 1 | P5_8_11  == 1 | P5_8_15  == 1 | P5_8_22  == 1) ~ 1,
